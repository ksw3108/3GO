...
<%
	...
	List <FoodRec> fList = service.getSearchFood(num); 
	System.out.println(fList.get(0).getTimestamp());
	System.out.println(fList.get(0).getKey());
%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=EUC-KR">
<title><%=fList.get(0).getC_name() %></title>
...
<div class="doc">
	<div class="cnt_head where">
		<h3 id="content_title"><%=fList.get(0).getC_name() %></h3>
		<ul>
			<li class="look">조회 : <%=fList.get(0).getC_rank() %></li>
		...
		<figure>
			<div class="grap">
				...
				<div class="slider">
					<div class="jquery-reslider">
						<div class="obj">
							<div class="slider-block"><img src="<%= fList.get(0).getImage() + "1.jpg"%>" alt=""></div>
							<div class="slider-block"><img src="<%= fList.get(0).getImage() + "2.jpg"%>" alt=""></div>
							<div class="slider-block"><img src="<%= fList.get(0).getImage() + "3.jpg"%>" alt=""></div>
							<div class="slider-block"><img src="<%= fList.get(0).getImage() + "4.jpg"%>" alt=""></div>
							<%-- <div class="slider-block"><img src="<%= fList.get(0).getImage() + "5.jpg"%>" alt=""></div> --%>
						</div>
			...
			<figcaption>
				<ul>
					<li>
						<b>위치</b>
						<span><%= fList.get(0).getC_addr() %></span>
					</li>
					<li>
						<b>문의/안내</b>
						<span><%= fList.get(0).getC_tel() %></span>
					</li>
				</ul>
			</figcaption>
...
<br/>
<br/>
<div id="daumRoughmapContainer<%= fList.get(0).getTimestamp() %>" class="root_daum_roughmap root_daum_roughmap_landing" style="margin: auto;"></div>
<script charset="UTF-8" class="daum_roughmap_loader_script" src="http://dmaps.daum.net/map_js_init/roughmapLoader.js"></script>
<script charset="UTF-8">
 new daum.roughmap.Lander({
  "timestamp" : "<%= fList.get(0).getTimestamp() %>",
  "key" : "<%= fList.get(0).getKey() %>",
  "mapWidth" : "700",
  "mapHeight" : "400"
 }).render();
</script>
