<%@ page language="java" contentType="text/html; charset=EUC-KR"
    ...
    String area_select = request.getParameter("area_select");
    String[] food = request.getParameterValues("food");
    	
    
     List <FoodRec> mList = service.getArticleList_Food(area_select, food);
	...
	<table class='search_view'>
		...
		<tr>
			...
			<td id='text_box' align='center' >
				<a href="searchFood.jsp?food_no=<%= mList.get(i).getF_no() %>" >
				<table class="search_view_two" align="center" onmouseover="javascript:onOver(this);" onmouseout="javascript:onOut(this);" style="border-radius: 10px;">
					<tr>
						<td><img alt="" src="<%= mList.get(i).getImage() + "1.jpg"%>" width="180px" height="120px" style="border-radius: 10px;"/></td>
					</tr>
					<tr align="center">
						<td width="180px" class="text" >
							<h6><%= mList.get(i).getC_kind() %></h6>
							<h5><%= mList.get(i).getC_name() %></h5>
						</td>
					</tr>
				</table>
				<br/>
