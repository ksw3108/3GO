	...
	<div class="header_top">
		...
		<div class="container">
			<div class="row">
				...
				<form id="frm" action="../login/loginConfirm.jsp" method="post">
					<div class="col-sm-6">
						<div class="social-icons pull-right">
							<ul class="nav navbar-nav">
								<li><input type="text" class="id guest-id" name="id" id="id" size="10" placeholder=" Id"></li>
								<li><input type="password" class="pw guest-pw" name="pw" id="pw" size="10" placeholder=" Password">&nbsp&nbsp </li>
								<li><a href="#" onclick="document.getElementById('frm').submit();"><i class="fa fa-user"></i> Login</a></li>
								<li><a href="register/registerForm.html"><i class="fa fa-user"></i>Account</a></li>
							</ul>
						</div>
					</div>					
				</form>
