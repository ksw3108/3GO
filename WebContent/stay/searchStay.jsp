...
%>
<%
	List <searchStay> sList = service.getSearchStay(num);
%>
...
<div class="doc">
	<div class="cnt_head where">
		...
		<ul>
			...
			<li class="likebutton"><button onclick="increaseCMSLikeCount('2384239'); return false;" id="likebtn" class="likeup" type="button" value="<%= sList.get(0).getLikes() %>"><%= sList.get(0).getLikes() %></button></li>
		</ul>
	</div>
...
<input type="hidden" name="snohidden" id="snohidden" value="<%= sList.get(0).getS_no() %>"/>
