                    ...
                    <table class="table table-condensed">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                <%= writer %> <span style='float:right'>조회 : <%= review.getB_count() %></span>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                ...
                                <span class="form-inline" role="form">
                                    <p>
                                        <div class="form-group">
                                        	...
                                        	<input type="text" id="commentParentName" name="commentParentName" class="form-control col-lg-2" data-rule-required="true" value="<%=lService.getReviewId(Integer.parseInt(m_no)) %>" maxlength="10">
                                        </div>
                                        <div class="form-group">
