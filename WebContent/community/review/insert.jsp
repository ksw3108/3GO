		...
		if(item.isFormField()){//입력항목이면
			...
			if(name!=null){
				if(name.equals("b_file1")){
					String b_file1 = service.save("D:\\JSP\\Final_Project\\WebContent\\community\\review\\uploadImage", item.getInputStream());
					rec.setB_file1(b_file1);
				}else if(name.equals("b_file2")){
					String b_file2 = service.save("D:\\JSP\\Final_Project\\WebContent\\community\\review\\uploadImage", item.getInputStream());
					rec.setB_file2(b_file2);
				}else if(name.equals("b_file3")){
					String b_file3 = service.save("D:\\JSP\\Final_Project\\WebContent\\community\\review\\uploadImage", item.getInputStream());
